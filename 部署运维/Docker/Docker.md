...
![docker出现前后对比](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\基础知识\docker出现前后对比.png)
...
![镜像文件的作用](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\基础知识\镜像文件的作用.png)



## 3、docker理念

![docker理念](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\基础知识\docker理念.png)
...
![传统虚拟机](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\基础知识\传统虚拟机.png)
...
![容器](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\基础知识\容器.png)
...
![三要素](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\基础知识\三要素.png)



## 2、docker运行图解（入门版）

![docker工作原理](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\基础知识\docker工作原理.png)
...
![docker架构](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\基础知识\docker架构.png)
...
![docker run的工作流程](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\基础知识\docker run的工作流程.png)
...
![docker和虚拟机比较](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\基础知识\docker和虚拟机比较.png)
...
![docker images](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker images.png)
...
![docker search](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker search.png)
...
![docker pull](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker pull.png)
...
![docker system df](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker system df.png)
...
![docker rmi](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker rmi.png)

- 删除所有

![docker rmi -qa](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker rmi -qa.png)
...
![虚悬镜像](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\虚悬镜像.png)
...
![docker run](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker run.png)
...
![docker ps](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker ps.png)
...
- 两种退出方式
  ...
  ![exit退出容器](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\exit退出容器.png)

  - ctrl+p+q：run进去容器，ctrl+p+q退出，容器不停止

  ![ctrl+p+q退出容器](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\ctrl+p+q退出容器.png)

- 两种比较

![两种退出比较](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\两种退出比较.png)
...
![docker rm](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker rm.png)
...
![没有前台进程的容器会自动退出](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\没有前台进程的容器会自动退出.png)
...
![前台启动redis](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\前台启动redis.png)

- 后台守护式启动 ：docker run -d redis

![后台运行redis](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\后台运行redis.png)
...
![docker logs](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker logs.png)
...
![docker top](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker top.png)
...
![docker inspect](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker inspect.png)
...
![docker exec](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker exec.png)

- docker attach 容器ID

![docker attach](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker attach.png)

- 区别：

  - **exec是在容器中打开新的终端，并且可以启动新的进程，用exit退出，不会导致容器的停止**

  ![进入容器方式区别1](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\进入容器方式区别1.png)

  - **attach直接进入容器启动命令的终端，不会启动新的进程，用exit退出，会导致容器的停止。**

  ![进入容器方式区别2](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\进入容器方式区别2.png)
...
![docker exec进入redis](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker exec进入redis.png)
...
![docker cp](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker cp.png)
...
![docker export](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker export.png)

- import 从tar包中的内容创建一个新的文件系统再导入为镜像[对应export]
  - **cat 文件名.tar.gz | docker import - 镜像用户/镜像名:镜像版本号**

![docker import](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker import.png)

- 用import生成的镜像文件

![docker import生成的镜像文件](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\docker import生成的镜像文件.png)

- 启动容器发现a.txt文件还在

![启动发现a.txt还在](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\启动发现a.txt还在.png)



### 3.10 命令总结

![命令总结](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\命令\命令总结.png)
...
![分层镜像](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\docker镜像\分层镜像.png)
...
![docker镜像加载原理](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\docker镜像\docker镜像加载原理.png)

-  平时我们安装进虚拟机的CentOS都是好几个G，为什么docker这里才200M？？

![虚拟机内存很小](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\docker镜像\虚拟机内存很小.png)
...
![容器层和镜像层](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\docker镜像\容器层和镜像层.png)
...
![默认不带vim](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\docker镜像\默认不带vim.png)

- 启动容器并安装vim，docker容器内执行两条命令：
  - **先更新我们的包管理工具：apt-get update**
  - **然后安装我们需要的vim：apt-get -y install vim**

![安装vim](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\docker镜像\安装vim1.png)

![安装vim2](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\docker镜像\安装vim2.png)
...
- 安装完成后，commit我们自己的新镜像：docker commit -m="自定义vim" -a="lzy" 容器ID 要创建的目标镜像名:[标签名]
  ...
  ![dokcer commit](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\docker镜像\dokcer commit.png)
...
![阿里云推送生态](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到本地仓库\阿里云推送生态.png)
...
![1](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到本地仓库\1.png)

- 选择控制台，进入容器镜像服务

![2](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到本地仓库\2.png)

- 选择个人实例

![3](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到本地仓库\3.png)

- 命名空间

![4](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到本地仓库\4.png)

![5](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到本地仓库\5.png)

- 仓库名称

![6](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到本地仓库\6.png)

![7](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到本地仓库\7.png)

![8](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到本地仓库\8.png)

- 进入管理界面获得脚本

![9](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到本地仓库\9.png)

![10](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到本地仓库\10.png)
...
![推送到本地仓库](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到本地仓库\推送到本地仓库.png)
...
![从本地仓库拉取镜像](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到本地仓库\从本地仓库拉取镜像.png)
...
![1](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到私有库\1.png)

- 运行私有库Registry，相当于本地有个私有Docker hub
  - docker run -d -p 5000:5000  -v /lzy/myregistry/:/tmp/registry --privileged=true registry
  - 默认情况，仓库被创建在容器的/var/lib/registry目录下，建议自行用容器卷映射，方便于宿主机联调

![2](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到私有库\2.png)
...
![3](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到私有库\3.png)
...
![4](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到私有库\4.png)

- curl验证私服库上有什么镜像
  -  curl -XGET http://127.0.0.1:5000/v2/_catalog

![5](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到私有库\5.png)

- 将新镜像lzyubuntu:1.2修改符合私服规范的Tag
  - 按照公式：docker tag  镜像:Tag  Host:Port/Repository:Tag
  - docker tag  lzyubuntu:1.2  127.0.0.1:5000/lzyubuntu:1.2

![6](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到私有库\6.png)
...
![7](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到私有库\7.png)

![8](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到私有库\8.png)
...
![9](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到私有库\9.png)

- pull到本地执行，可以直接用ifconfig
  - docker pull 127.0.0.1:5000/lzyubuntu:1.2

![10](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\推送镜像到私有库\10.png)
...
![容器数据卷](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\容器数据卷\容器数据卷.png)
...
![运行带数据卷的容器](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\容器数据卷\运行带数据卷的容器.png)
...
![查看数据卷是否挂载成功](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\容器数据卷\查看数据卷是否挂载成功.png)
...
![数据卷之间数据共享](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\容器数据卷\数据卷之间数据共享.png)
...
![读写1](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\容器数据卷\读写1.png)

![读写2](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\容器数据卷\读写2.png)
...
​     ![只读权限1](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\容器数据卷\只读权限1.png)

- 宿主机可以修改，容器会实时同步

![只读权限2](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\容器数据卷\只读权限2.png)
...
![映射1](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\容器数据卷\映射1.png)

- 容器2继承容器1的卷规则
  - docker run -it --privileged=true --volumes-from u1 --name=u2 ubuntu /bin/bash

![映射2](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\容器数据卷\映射2.png)
...
![tomcat安装1](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\常用软件安装\tomcat安装1.png)

![tomcat安装2](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\常用软件安装\tomcat安装2.png)
...
![重启之后的数据还是在](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\常用软件安装\重启之后的数据还是在.png)
...
![redis配置文件修改](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\常用软件安装\redis配置文件修改.png)

- 证明用了自定义的配置文件

  - 修改配置文件个数为10

  ![redis配置文件修改数据库个数10](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\常用软件安装\redis配置文件修改数据库个数10.png)

  - 重启服务：docker restart c112fabb2e32
  - 再登陆进去用select 10验证

  ![select 15报错](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\常用软件安装\select 15报错.png)
...
![DockerFile](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\DockerFile\DockerFile.png)
...
![dockerFile总结](C:\Users\lzy\Desktop\work\部署运维\Docker\图片\DockerFile\dockerFile总结.png)
