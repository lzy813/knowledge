...
- 常用配置项：（<font color="red">**注意：不要在json里加注释**</font>）
...
6. https://github.com/multica-ai/andrej-karpathy-skills



### 2.3 第二层记忆：Auto Memory
...
- <font color="red">**Explore → Plan → Implement → Commit**</font>
...
![Claude Code 创建 Express 项目流程示意](E:/knowledge/01.%E7%AC%94%E8%AE%B0/images/claude-express-workflow.svg)
...
![项目文件结构与 Git 提交流程示意](E:/knowledge/01.%E7%AC%94%E8%AE%B0/images/project-tree-git-flow.svg)
