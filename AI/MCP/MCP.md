...
- 官网地址：[https://modelcontextprotocol.io/introduction](https://link.wtturl.cn/?target=https%3A%2F%2Fmodelcontextprotocol.io%2Fintroduction&scene=im&aid=497858&lang=zh)

|   特征   |                         MCP                         |         TCP/IP、HTTPS          |
| :------: | :-------------------------------------------------: | :----------------------------: |
| **本质** |                  协议（Protocol）                   |        协议（Protocol）        |
| **作用** | 标准化 AI 模型与上下文来源 / 工具之间的数据交互方式 | 标准化 设备之间 的网络通信方式 |
